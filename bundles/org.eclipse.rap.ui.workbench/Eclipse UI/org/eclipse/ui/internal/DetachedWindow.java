...
public class DetachedWindow implements IDragOverListener {
    ...
    public DetachedWindow(WorkbenchPage workbenchPage) {
        ...
        folder = new ViewStack(page, false, PresentationFactoryUtil.ROLE_STANDALONE_NOTITLE, null);
...
//                  IWorkbenchPartReference partReference = pane.getPartReference();
//                  if (partReference != null) {
//                     ((WorkbenchPartReference)partReference).dispose();
//                  }
//                  
//               }
//              }
