...
public class DragUtil {
    ...
    public static boolean performDrag(final Object draggedItem,
        ...
        //HACK: drop is moved to dragToTarget
//        target.drop();
//
...
//        }
    ...
    static IDropTarget dragToTarget(final Object draggedItem,
       ...
       Control dragControl = SwtUtil.findControl(display, initialLocation);
       final DragSource dragSource = (DragSource)dragControl.getData(DND.DRAG_SOURCE_KEY);
            ...
            public void handleEvent(final Event event) {
                display.syncExec(new Runnable() {
                    public void run() {
                        ...
                        Point location = display.getCursorLocation();//new Point(event.x, event.y);
...
//        }
        ...
        Job dragJob = new Job("Drag-Job") {
           protected IStatus run(IProgressMonitor monitor)
         {
             ...
             final boolean trackingOk = tracker.open();
